...
function theme_scripts() {
  wp_enqueue_style('bridges-to-science-css', get_template_directory_uri() . '/dist/style/main.css');
  wp_enqueue_script( 'bridges-to-science-js', get_template_directory_uri() . '/dist/js/main.js', array(), '1.0', true );
}
